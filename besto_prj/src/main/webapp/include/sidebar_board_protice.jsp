               ...
               <div class="panel-heading">
                ...
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm">
                    ...
                    <li class="nav-item"><a href="board_protice_faq.jsp" class="nav-link"><span><font color="black">FAQ</font></span></a></li>
                    <li class="nav-item"><a href="board_protice_use.jsp" class="nav-link"><span><font color="black">사이트 이용안내</font></span></a></li>
