...
<!-- 게시판 메인부분 -->
            <div class="col-md-10">
              ...
              <div id="basket" class="col-lg-12">
                <form name = "board" method="post" action="/board_free_hit_register.do">
...
<!-- 승부식이라면 아래의 테이블을 보여야함 -->
                ...
                <br>  
                  ...
                  <div class="col-sm-10">
                    <div class="form-group">
                    <input name = "hithistoryDiscussionTitle"  id="hithistoryDiscussionTitle" class="form-control" type="text" placeholder="제목을 입력하세요" style="width:875px;"><br>
                    <textarea name = "hithistoryDiscussionContent"  id="hithistoryDiscussionContent" class="form-control" placeholder="내용을 입력하세요" style="margin-top: 0px; margin-bottom: 0px; height: 240px; width: 875px;"></textarea>
                    </div>
                    </div>
